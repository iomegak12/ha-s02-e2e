...
/// <summary>Bootstraps Serilog as the host logger.</summary>
public static class SerilogBootstrap
{
    public const string ServiceName = "nexus-patient";
    ...
    public static void Configure(WebApplicationBuilder builder)
    {
        builder.Host.UseSerilog((context, services, logger) =>
        {
            ...
            var filePath = context.Configuration["Logging:File:Path"] ?? "logs/patient-.log";
